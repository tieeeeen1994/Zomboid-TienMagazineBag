...
- **Reload Magazines** — ejects a part-used magazine from your gun, refills every magazine you are carrying using rounds from your inventory and your bags, then loads one back into the gun. It picks a magazine holding the same round you were last firing, or your biggest magazine if none do.
...
In B42 you can also turn on "Open Boxes" versions of Reload Magazines and Fetch Fresh Ammo in Settings. They open just enough ammo boxes to cover what your loose rounds can't, and only show up when there is a box worth opening.

Each entry can be turned on or off, per player, in Settings.

With a B42 gun pack built on Gunworks Gang, you also get:

- **Every magazine your gun takes** — a rifle that takes 20, 30 and 60 round magazines has all of them stored, reloaded and fetched.
- **Every kind of round** — hollow point, armor piercing, subsonic and the rest your gun accepts are stored and fetched together, whatever is loaded right now.
